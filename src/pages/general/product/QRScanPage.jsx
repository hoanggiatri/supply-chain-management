...
const QRScanPage = () => {
    ...
    return (
        <Container maxWidth="sm">
            <Paper className="paper-container" elevation={3} sx={{ p: 3, mt: 4, textAlign: "center" }}>
                ...
                {scanError ? (
                    <Box mb={3}>
                        <Typography color="error" gutterBottom>{scanError}</Typography>
                        <Button variant="contained" color="primary" onClick={handleResetScan}>
                            Quét lại
                        </Button>
                    </Box>
                ) : (
