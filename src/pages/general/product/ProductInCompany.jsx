    ...
    useEffect(() => {
        const fetchProducts = async () => {
            try {
                ...
                toastrService.error(error.response?.data?.message || "Có lỗi xảy ra khi lấy danh sách sản phẩm!");
            }
        };
        ...
        <Container>
            <Paper className="paper-container" elevation={3}>
                ...
                <Box mt={3} mb={3} display="flex" gap={2}>
                    ...
                    <Button variant="contained" color="secondary" onClick={() => navigate("/scan-qr")}>
                        Quét QR
                    </Button>
                </Box>
                <DataTable
                    ...
                    renderRow={(product) => (
                        ...
                        >
                            ...
                            <TableCell>{product.createdDate ? new Date(product.createdDate).toLocaleDateString() : ""}</TableCell>
                        </TableRow>
                    )}
                />
            </Paper>
