...
const InventoryCount = () => {
  ...
  return (
    <ListPageLayout
      breadcrumbs="Kho / Kiểm kê"
      title="Kiểm kê kho"
      description="Cập nhật số lượng tồn kho thực tế so với hệ thống"
      actions={
        <AddButton
          label="Tạo tồn kho mới"
    ...
    >
      ...
      <DataTable
        ...
        renderRow={(inventory, index) => {
          ...
          return (
            <tr key={inventory.inventoryId || index} className="group even:bg-[#F8F9FC] odd:bg-white border-b hover:bg-gray-50">
