...
import { useReceiveTicketsInCompany } from '../../../hooks/useApi';
...
const ReceiveTicketList = () => {
  ...
  const { data: tickets = [], isLoading, refetch } = useReceiveTicketsInCompany();
  ...
  const handleTicketClick = (ticket) => {
    navigate(`/marketplace-v2/warehouse/receive-ticket/${ticket.ticketId}`);
  };
      ...
      >
        <div className="flex items-center gap-3">
          <div className="p-3 rounded-xl" style={{ backgroundColor: '#22c55e20' }}>
            <ArrowDownToLine size={24} style={{ color: '#22c55e' }} />
          </div>
          <div>
