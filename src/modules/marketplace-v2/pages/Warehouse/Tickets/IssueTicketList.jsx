...
import { useIssueTicketsInCompany } from '../../../hooks/useApi';
...
/**
 * Issue Ticket List Page
 */
const IssueTicketList = () => {
  ...
  const { data: tickets = [], isLoading, refetch } = useIssueTicketsInCompany();
  ...
  const handleTicketClick = (ticket) => {
    navigate(`/marketplace-v2/warehouse/issue-ticket/${ticket.ticketId}`);
  };
      ...
      >
        <div className="flex items-center gap-3">
          <div className="p-3 rounded-xl" style={{ backgroundColor: '#ef444420' }}>
            <ArrowUpFromLine size={24} style={{ color: '#ef4444' }} />
          </div>
          <div>
