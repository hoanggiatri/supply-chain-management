...
import {
  useReceiveTicketById,
  useUpdateReceiveTicket,
} from "../../../hooks/useApi";
          ...
          await updateTransferTicket(
            ticket.referenceId,
            {
              ...
              transferTicketDetails: (
                transferTicket.transferTicketDetails || []
              ).map((detail) => ({
            ...
            <div className="flex items-center gap-3">
              ...
              {showMoNavigateButton && ticket.referenceId && (
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  onClick={() =>
                    navigate(`/marketplace-v2/mo/${ticket.referenceId}`)
                  }
                  className="mp-btn mp-btn-secondary"
                >
                  Xem lệnh sản xuất
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  >
                    {ticket.receiveDate
                      ? new Date(ticket.receiveDate).toLocaleString("vi-VN")
                      : "Chưa nhập"}
                  </p>
                </div>
              </div>
          ...
          >
            ...
            <div className="mt-6 pt-6 border-t border-gray-100 dark:border-gray-800">
              <div className="flex flex-col items-end space-y-2">
                ...
                <div
                  className="flex justify-between w-full max-w-xs pt-2 border-t"
                  style={{ borderColor: "var(--mp-border-light)" }}
                >
                  <span
                  ...
                  <span className="text-xl font-bold text-green-500">
                    {(ticket.receiveTicketDetails || []).reduce(
              ...
              <div>
                ...
                >
                  {ticket.lastUpdatedOn
                    ? new Date(ticket.lastUpdatedOn).toLocaleString("vi-VN")
                    : "---"}
                </p>
              </div>
            </div>
