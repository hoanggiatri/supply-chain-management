...
const WarehouseCard = ({ warehouse, onEdit }) => {
  return (
    <motion.div
      layout
      className="mp-glass-card p-5 group hover:border-blue-500/30 transition-all"
      whileHover={{ y: -4 }}
    >
      ...
      <div className="space-y-3 mb-5">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="p-2 rounded-lg bg-gray-50 dark:bg-white/5">
             ...
             <span className="text-sm font-medium" style={{ color: 'var(--mp-text-secondary)' }}>{warehouse.warehouseType}</span>
          </div>
          <div className="p-2 rounded-lg bg-gray-50 dark:bg-white/5">
      ...
      <motion.button
        ...
        className="w-full py-2 rounded-lg border border-gray-200 dark:border-gray-700 flex items-center justify-center gap-2 text-sm font-medium transition-colors hover:bg-gray-50 dark:hover:bg-white/5"
